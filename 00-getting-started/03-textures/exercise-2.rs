...
const VERTICES: &[Vertex] = &[
    ...
    Vertex { translation: Vec3 { x: -0.5, y:  0.5, z:  0.0 }, uv: Vec2 { x: 0.0, y: 2.0 } },
    Vertex { translation: Vec3 { x:  0.5, y:  0.5, z:  0.0 }, uv: Vec2 { x: 2.0, y: 2.0 } },
    Vertex { translation: Vec3 { x:  0.5, y: -0.5, z:  0.0 }, uv: Vec2 { x: 2.0, y: 0.0 } },
];
    ...
    event_loop.run(move |event, _, control_flow| match event {
        ...
        Event::RedrawRequested(_) => {
                ...
                device.create_command_encoder(&wgpu::CommandEncoderDescriptor { todo: 0 });
            {
                ...
                render_pass.set_bind_group(0, &texture_1_bind_group, &[]);
                render_pass.set_bind_group(1, &texture_2_bind_group, &[]);
